...
import (
	...
	"k8s.io/otdd-controller/pkg/generated/clientset/versioned/scheme"
)
...
// NetworkingV1alpha1Client is used to interact with features provided by the networking.otdd.io group.
type NetworkingV1alpha1Client struct {
	restClient rest.Interface
}

func (c *NetworkingV1alpha1Client) Recorders(namespace string) RecorderInterface {

...
import (
	...
	otddcontrollerv1alpha1 "k8s.io/otdd-controller/pkg/apis/otddcontroller/v1alpha1"
	versioned "k8s.io/otdd-controller/pkg/generated/clientset/versioned"
	internalinterfaces "k8s.io/otdd-controller/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "k8s.io/otdd-controller/pkg/generated/listers/otddcontroller/v1alpha1"
)
...
type RecorderInformer interface {
	...
	Lister() v1alpha1.RecorderLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.NetworkingV1alpha1().Recorders(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NetworkingV1alpha1().Recorders(namespace).Watch(options)
			},
		},
		&otddcontrollerv1alpha1.Recorder{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *recorderInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&otddcontrollerv1alpha1.Recorder{}, f.defaultInformer)
}

func (f *recorderInformer) Lister() v1alpha1.RecorderLister {
	return v1alpha1.NewRecorderLister(f.Informer().GetIndexer())
}
